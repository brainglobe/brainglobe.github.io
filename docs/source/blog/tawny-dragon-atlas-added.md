...
- **Atlas name:** `hoops_tawny_dragon_50um`
...
* Open napari and follow the steps in our [download tutorial](/tutorials/manage-atlases-in-GUI.md) for `hoops_tawny_dragon_50um`
