...
# New mouse brain atlas based on gene expression patterns added
...
In the future, atlases regions may be defined automatically based on cell type, pathology, or other properties which can be mapped to a template. This atlas and the accompanying gene expression dataset is now available on [bioRxiv](https://doi.org/10.64898/2026.01.20.700446). 
