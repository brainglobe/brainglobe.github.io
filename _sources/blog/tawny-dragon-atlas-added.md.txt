...
- **Atlas name:** `hoops_tawny_dragon_20um`
- **Resolution:** 20 µm isotropic
- **Modality:** MRI
...
* Open napari and follow the steps in our [download tutorial](/tutorials/manage-atlases-in-GUI.md) for `hoops_tawny_dragon_20um`
